...
define( 'FT_NONCE_UNIQUE_KEY' , 'M]0X:4fMPk<r+-u3^iIAXiWBh]|rlZt:gERgh^{tBw@PNKH;L(N?Yrgv<g(KIrDs' );
define( 'FT_NONCE_DURATION' , 10000 ); // 300 makes link or form good for 5 minutes from time of generation
