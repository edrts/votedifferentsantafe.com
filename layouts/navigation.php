<nav class="navbar navbar-default sticker navbar-expand-md mb-3 sticky-top">
    <div class="container-fluid">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
            <a class="navbar-brand" href="/">
                <img class="olivia-owl" alt="Brand" src="/img/OliviaOwl.svg">
            </a>
            <div class="checkbox">
                <label class="language">
                    <input id="language-toggle" name="language" type="checkbox" data-toggle="toggle"
                           data-on="Switch to English" data-off="Switch to Español" data-onstyle="info"
                           data-offstyle="info" data-size="normal">
                </label>
            </div>
            <button class="navbar-toggle toggle-nav" type="button" aria-label="Toggle navigation">
              <i class="fas fa-bars"></i>
            </button>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="navbar-collapse d-none d-md-flex" id="bs-example-navbar-collapse-1">
          <ul class="navbar-nav mt-2 mt-lg-0">
            ...
            <li class="dropdown px-1 px-lg-3">
